...
To provide a better user experience, you can check whether the user prefers dark mode using JavaScript. This can be done by accessing the user's system preferences and setting the theme of your application accordingly. remember to add use effect (logic is that when the app launches the user color pref are checked and updated accordingly)
